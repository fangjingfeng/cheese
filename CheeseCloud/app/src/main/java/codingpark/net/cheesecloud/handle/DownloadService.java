...
public class DownloadService extends IntentService {
    ...
    private static final String EXTRA_PARAM1 = "codingpark.net.cheesecloud.handle.extra.PARAM1";
    private static final String EXTRA_PARAM2 = "codingpark.net.cheesecloud.handle.extra.PARAM2";
