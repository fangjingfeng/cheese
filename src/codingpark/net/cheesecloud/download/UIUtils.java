...
public class UIUtils {
	...
	public static Context getContext() {
		/*return MyBaseApplication.getContext();*/
		return null;
	}
	...
	public static Handler getHandler() {
		//return MyBaseApplication.getHandler();
		return null;
	}
	...
	public static void startActivity(Intent intent){
		/*//BaseActivity activity = BaseActivity.getForengroundActivity();
		if(activity != null){
	...
	private static void showToast(String str) {
		/*BaseActivity frontActivity = BaseActivity.getForengroundActivity();
