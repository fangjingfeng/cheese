...
public class WsSyncFile implements KvmSerializable {
	...
	public String toString() {
		return "WsSyncFile [IsPreview=" + IsPreview + ", FullName=" + FullName
				+ ", FatherID=" + FatherID + ", CreatDate=" + CreatDate
				+ ", Extend=" + Extend + ", CreaterID=" + CreaterID
				+ ", PhyInfo=" + PhyInfo + ", IsShow=" + IsShow + ", ID=" + ID
				+ ", Name=" + Name + ", UsedSpaceSizeKB=" + UsedSpaceSizeKB
				+ ", RecycleDate=" + RecycleDate + ", Recycler=" + Recycler
				+ ", IsRecycled=" + IsRecycled + ", TranCodeType="
				+ TranCodeType + ", DownCount=" + DownCount + ", LookCount="
				+ LookCount + ", SizeB=" + SizeB + ", MD5=" + MD5
				+ ", SyncType=" + SyncType + ", BlockIndex=" + BlockIndex
				+ ", IsFinally=" + IsFinally + ", Blocks=" + Blocks + "]";
	}
